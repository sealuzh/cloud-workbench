Rails.application.configure do
  ...
  # when problems arise.
  # Level: :debug, :info, :warn, :error, :fatal, :unknown for 0 to 5
  ...
  # config.active_job.queue_name_prefix = "cloud_benchmarking_#{Rails.env}"
  ...
  # Proposed logging config from Rails 5
